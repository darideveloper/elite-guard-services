...
class Neighborhood(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name="Nombre de la colonia")
...
class MaritalStatus(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=100, verbose_name="Nombre del estado civil")
...
class Employee(models.Model):
    ...
    last_name_2 = models.CharField(
        max_length=100, verbose_name="Apellido materno", blank=True, null=True
    )
    ...
    municipality_birth = models.CharField(
        max_length=100, verbose_name="Lugar de nacimiento", blank=True, null=True
    )

    # Work info
    is_eventual = models.BooleanField(default=False, verbose_name="Es eventual")
    ...
    phone = models.CharField(
        max_length=10, verbose_name="Teléfono", unique=True, blank=True, null=True
    )
    emergency_phone = models.CharField(
        max_length=10, verbose_name="Teléfono de emergencia", blank=True, null=True
    )
    ...
    balance = models.FloatField(
        verbose_name="Saldo de préstamos", default=0, blank=True, null=True
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if is_new:
            ...
            employee_services = services_models.Service.objects.filter(employee=self.pk)
...
class Loan(models.Model):
    ...
    employee = models.ForeignKey(
        Employee, on_delete=models.CASCADE, verbose_name="Empleado"
    )
    ...
    date = models.DateTimeField(
        default=timezone.now, verbose_name="Fecha de prestamo o pago"
    )
...
class Relative(models.Model):
    ...
    last_name_1 = models.CharField(max_length=100, verbose_name="Apellido paterno")
    last_name_2 = models.CharField(
        max_length=100, verbose_name="Apellido materno", null=True, blank=True
    )
    relationship = models.ForeignKey(
        Relationship, on_delete=models.PROTECT, verbose_name="Parentesco"
    )
